...
public class PolicyHandler {
    ...
    public void wheneverFoodStarted_FoodEnded(
        @Payload FoodStarted foodStarted
    ) {
        FoodStarted event = foodStarted;
        System.out.println(
            "\n\n##### listener FoodEnded : " + foodStarted + "\n\n"
        );

        // Sample Logic //
        Delivery.foodEnded(event);
    }
    ...
    @StreamListener(
        value = KafkaProcessor.INPUT,
        condition = "headers['type']=='StartDelivery'"
    )
    public void wheneverStartDelivery_SendNoti(
        @Payload StartDelivery startDelivery
    ) {
        StartDelivery event = startDelivery;
        System.out.println(
            "\n\n##### listener SendNoti : " + startDelivery + "\n\n"
        );
        // Sample Logic //
